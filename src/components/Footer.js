        ...
        <div className="p-4 flex flex-col">
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center justify-center mb-2">
              ...
              <a href="https://wa.me/573135681595" target='blank' className="hover:underline">312 5098505</a>
            </div>
            <div className="flex items-center justify-center">
              <FaWhatsapp className="mr-2" />
              <a href="https://wa.me/573502521463" target='blank' className="hover:underline">305 2951490</a>
            </div>
          </div>
